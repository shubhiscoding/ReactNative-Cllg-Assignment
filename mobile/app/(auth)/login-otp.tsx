...
import { verifyLoginOTP, requestLoginOTP } from "@/store/authSlice";
...
export default function LoginOTP() {
  ...
  const handleVerify = async () => {
    ...
    const result = await dispatch(verifyLoginOTP({ email, otp: otpString }));
    ...
    >
      <View className="flex-1 px-6 pt-16">
        ...
        <View className="mb-8">
          ...
          <Text className="font-bold text-3xl text-secondary">Sign In with OTP</Text>
